...
function Drive({ token, user, openAdmin }) {
  ...
  function goHome() { setActive(null); setFileData(null); setTrail([]); setMenu(null); setFolderMenu(null); setMessage(""); }
  ...
  return <div className="min-h-screen">
    ...
    <main className="grid w-full gap-5 p-5 lg:grid-cols-[240px_minmax(0,1fr)]">
